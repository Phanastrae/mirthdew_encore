...
public class DreamtwirlChunkGenerator extends ChunkGenerator {
    public static final MapCodec<DreamtwirlChunkGenerator> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(RegistryOps.getEntryCodec(MirthlightEncoreBiomes.DREAMTWIRL)).apply(instance, instance.stable(DreamtwirlChunkGenerator::new))
    );

    protected static final BlockState DREAMTWIRL_BARRIER = MirthlightEncoreBlocks.DREAMTWIRL_BARRIER.getDefaultState();
