...
public class DreamtwirlSkyRenderer {
    private static final Identifier DREAMTWIRL_SKY_SPIRIT = MirthdewEncore.id("textures/environment/dreamtwirl_sky_spirit.png");
    private static final Identifier DREAMTWIRL_NOVA = MirthdewEncore.id("textures/environment/dreamtwirl_nova.png");
    private static final Identifier DREAMTWIRL_NOVA_SWIRL = MirthdewEncore.id("textures/environment/dreamtwirl_nova_swirl.png");
    private static final Identifier DREAMTWIRL_LANDSCAPE_SKY_TWIRL = MirthdewEncore.id("textures/environment/dreamtwirl_landscape_sky_twirl.png");
    private static final Identifier DREAMTWIRL_LANDSCAPE_CIRCUS = MirthdewEncore.id("textures/environment/dreamtwirl_landscape_circus.png");
    private static final Identifier DREAMTWIRL_LANDSCAPE_BACK_MOUNTAINS = MirthdewEncore.id("textures/environment/dreamtwirl_landscape_back_mountains.png");
    private static final Identifier DREAMTWIRL_LANDSCAPE_WATER = MirthdewEncore.id("textures/environment/dreamtwirl_landscape_water.png");
