...
import static phanastrae.mirthdew_encore.component.MirthdewEncoreDataComponentTypes.LINKED_DREAMTWIRL;
...
public class SlumberingEyeItem extends Item {
    ...
    public boolean isFoil(ItemStack stack) {
        if (stack.has(LOCATION_COMPONENT) || stack.has(LINKED_DREAMTWIRL)) {
            return true;
        } else {
